info.onCountdownEnd(function () {
    ...
    game.showLongText("Alright Theyre Gone", DialogLayout.Bottom)
    game.showLongText("Lets Start Shooting", DialogLayout.Bottom)
    ...
    game.setDialogFrame(img`
        ...
        f f f f f f f f f f f f f f f 
        `)
    game.showLongText("Bummerland, here I am", DialogLayout.Full)
    game.showLongText("Better nix my summer plans", DialogLayout.Full)
    game.showLongText("Bummerland, give a cheer", DialogLayout.Full)
    game.showLongText("'Cause you're only going up from here", DialogLayout.Full)
})
...
let mySprite = sprites.create(assets.image`Jack`, SpriteKind.Player)
...
scene.setBackgroundImage(img`
    ...
    `)
music.play(music.createSong(assets.song`Bummerland`), music.PlaybackMode.LoopingInBackground)
game.showLongText("Alright We can Shoot Bummerland Here!", DialogLayout.Bottom)
game.showLongText("Oh Shit, Run!", DialogLayout.Bottom)
info.setLife(4)
